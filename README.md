...
To take a look at carddown's Markdown capabilities you can download
 [examples/markdown_demo.html](./examples/markdown_demo.html) and open it in a web browser. It is an output file, that was generated by carddown, showcasing the supported Markdown syntax.
